...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--model_type', type=str, default='GLMModel', required=False, choices=['GLMModel', 'OpenAIModel'], help='The type of translation model to use. Choose between "GLMModel" and "OpenAIModel".')        
        ...
        self.parser.add_argument('--openai_base_url', type=str, help='The base URL for OpenAIModel.".')
